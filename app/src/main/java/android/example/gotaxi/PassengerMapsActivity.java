package android.example.gotaxi;
...
public class PassengerMapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bookTaxiButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bookTaxiButton.setText("Мы ищем для вас такси");
    ...
    private void getNearestDriverLocation() {
        ...
        bookTaxiButton.setText("определение местонахождения водителя");
        nearestDriverLocation = FirebaseDatabase.getInstance().getReference().child("driversGeoFire")
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng passengerLocation = new LatLng(-34, 151);
        ...
        settingsClient.checkLocationSettings(locationSettingsRequest).
                addOnSuccessListener(this, new OnSuccessListener<LocationSettingsResponse>() {
                    ...
                    public void onSuccess(LocationSettingsResponse locationSettingsResponse) {
                        ...
                        if (ActivityCompat.checkSelfPermission(PassengerMapsActivity .this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(PassengerMapsActivity .this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        switch (statusCode){
                            ...
                            case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                ...
                                String message = "Настроить параметры местоположения в устройстве";
            ...
            case CHECK_SETTINGS_CODE:
                switch (resultCode) {
                    case Activity.RESULT_OK:
                        Log.d("MainActivity", "Пользователь согласился изменить " +
                                "настройки");
                        startLocationUpdates();
                        break;

                    case Activity.RESULT_CANCELED:
                        Log.d("MainActivity", "Пользователь не согласился изменить " +
                                "настройки");
                        isLocationUpdatesActive = false;
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_LOCATION_PERMISSION){
            if (grantResults.length <=0){
                ...
                showSnackBar(
                        "Включить настройки местоположения ",
                        "Настройки",
                        new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
